...
final class RedisSessionExpirationPolicy {
    ...
    private static final Logger logger = LoggerFactory.getLogger(MyRedisOperationsSessionRepository.class);
    ...
    String getSessionKey(String sessionId) {
        return MyRedisOperationsSessionRepository.BOUNDED_HASH_KEY_PREFIX + sessionId;
    }
