...
/**
 * @author zhangyong 2016年8月23日下午7:40:37
 */
public class MyRedisOperationsSessionRepository implements SessionRepository<MyRedisOperationsSessionRepository.RedisSession> {

    /**
     * The prefix for each key of the Redis Hash representing a single session. The suffix is the unique session id.
     */
    static final String BOUNDED_HASH_KEY_PREFIX = "";
     ...
     */
    public MyRedisOperationsSessionRepository(RedisOperations<String, ExpiringSession> sessionRedisOperations) {
