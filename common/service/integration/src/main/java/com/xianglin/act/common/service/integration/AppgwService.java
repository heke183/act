...
public interface AppgwService {
     ...
     * @return
     */
     <T> T service(Class interfaceName, String method, Class<T> result, Object... paras);
     ...
     * @return
     */
    <T> List<T> serviceList(Class interfaceName, String method, Class<T> geneType, Object... paras);
}
