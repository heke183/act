 ...
 */
package com.xianglin.act.common.util.modelmapper;

import com.xianglin.act.common.util.dbconfig.EnableDbConfigBean;
 ...
 */
@EnableDbConfigBean(scanPackage = "com.xianglin.act.common.util.config.db")
