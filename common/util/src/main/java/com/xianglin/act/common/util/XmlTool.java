...
public class XmlTool {
     ...
     * @return
     */
    public static String getSoapRequestData(Map<String, String> map) {
     ...
     * @return
     */
    public static Map<String, String> getResponseData(String xml) {
        ...
        try {
            ...
            NodeList xmlList = document.getElementsByTagName("xml");

            for (int i = 0; i < xmlList.getLength(); i++) {
                Node node = xmlList.item(i);
                NodeList childList = node.getChildNodes();
                for (int t = 0; t < childList.getLength(); t++) {
                    if (childList.item(t).getNodeType() == Node.ELEMENT_NODE) {
                        result.put(childList.item(t).getNodeName(), childList.item(t).getTextContent());
                    }
                }
            }
        } catch (Exception e) {
